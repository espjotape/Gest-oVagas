...
import br.com.joaopedro.gestao_vagas.modules.company.useCases.CreateJobUseCase;
import br.com.joaopedro.gestao_vagas.modules.company.useCases.ListAllJobsByCompanyUseCase;
...
public class JobController {
    ...
    @Operation(summary = "Listagem das vagas", description = "Essa função é responsável por listar as vagas da empresa")
    @ApiResponse(responseCode = "200", content = {
        @Content(schema = @Schema(implementation = JobEntity.class))
    })
    @SecurityRequirement(name = "jwt_auth")
